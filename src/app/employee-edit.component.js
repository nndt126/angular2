...
var EmployeeEditComponent = (function () {
    ...
    EmployeeEditComponent.prototype.ngOnInit = function () {
        ...
        this.employeeService.getEmployeeById(this._id).subscribe(function (data) {
            _this.employee = data;
        }, function (error) {
            console.log(error);
        });
    ...
    EmployeeEditComponent.prototype.SaveForm = function () {
        var _this = this;
        this.employeeService.UpdateEmployee(this._id, this.employee).subscribe(function (response) {
            if (response) {
                alert('Save success');
